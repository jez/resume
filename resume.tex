...
Paraellel Computer Programming\\
Machine Learning\\
...
Ryby \textbullet{} C \textbullet{} C++ \textbullet{} Java \\
\sectionsep
...
\location{Sep 2013 – Present | CMU student organization}
\begin{tightemize}
...
\descript{| Lead Teaching Assistant}
\location{Aug 2014 – Present}
\begin{tightemize}
\item Teach core, practical CS concepts to incoming freshmen
\item Topics include \custombold{Unix systems}, \custombold{bash},
  \custombold{Vim/emacs}, \custombold{git}, \custombold{make}, \custombold{gdb},
  \custombold{valgrind}
\end{tightemize}
\sectionsep
...
\item Version control your Spotify playlists by taking snapshots and restoring
  to them
\item Loving developed with \custombold{Node.js} and \custombold{React.}
\end{tightemize}
\sectionsep
...
\item Built using \custombold{Node.js} and \custombold{AWS.} Won Amazon's
  sponsored prize at \custombold{TartanHacks}
\end{tightemize}
\sectionsep
